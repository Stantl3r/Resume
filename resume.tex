...
\\ \itab{Algorithms and Abstract Data Types} \tab{}  \tab{Introduction to Probability Theory}
\\ \itab{Introduction to Data Structures}  \tab{}  \tab{Linear Algebra} 
\\ \itab{Introduction to Programming}  \tab{} \tab{Vector Calculus}
\\ \itab{Applied Discrete Mathematics}
\\ \itab{Computer Systems \& Assembly Language}
\end{rSection}
